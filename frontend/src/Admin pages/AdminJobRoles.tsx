...
import JobRolesStats from "../components/JobRoles/JobRolesStats";
...
import { initialJobRoles, type JobRole } from "../data/jobRoles";


const AdminJobRoles = () => {
  const [roles, setRoles] = useState<JobRole[]>(initialJobRoles);
      ...
      <Box sx={{ flexGrow: 1 }}>
        ...
        <Box sx={{ p: 4 }}>
          ...
          <JobRolesToolbar
            ...
            onAddRole={() => setOpenAddDialog(true)}
          />
          </Box>
